...
const translations = {
  en: {
    ...
    'landing.context.title': 'Legacy: Blue Prince (2025) Translation',
    'landing.context.desc': 'The team successfully localized the IL2CPP game using BepInEx and XUnity.AutoTranslator, recreating TMP 1.4.0 fonts to support Chinese and Roman numerals.',
  ...
  zh: {
    ...
    'landing.context.title': '历史战绩: Blue Prince (2025) 汉化项目',
    'landing.context.desc': '小组曾成功使用 Unity IL2CPP、BepInEx 及 XUnity.AutoTranslator，通过重制 TMP 1.4.0 字体与配置自研代理成功汉化该大作，本 Wiki 正是小组协作沉淀的结晶。',
