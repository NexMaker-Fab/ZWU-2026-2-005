...
const translations = {
  en: {
    ...
    'welcome.badge': '✨ TeamFlow Wiki v1.2',
    'welcome.subtitle': 'A lightweight, modular, collaborative knowledge base designed for modern development teams.',
    'welcome.action.start': 'Start Writing',
    'welcome.action.settings': 'Configure Sync',
    'welcome.action.edit_layout': 'Edit Layout',
    'welcome.team.title': 'Project Contributors',
    'welcome.team.desc': 'Special thanks to the development and design team members of TeamFlow Wiki:',
    'welcome.team.role.lead': 'Project Lead / Core Developer',
    'welcome.team.role.frontend': 'Frontend Architect',
    'welcome.team.role.designer': 'UI / UX Designer',
    'welcome.team.role.ai': 'AI Pair Programmer',
    'welcome.guide.title': 'Usage Guide',
    'welcome.guide.desc': 'Quickly master the core collaborative workflow of TeamFlow Wiki:',
    'welcome.guide.step1.title': 'Block-based Editing',
    'welcome.guide.step1.desc': 'Click any text block to edit directly, press Enter to create a new line. Every block is an independent element.',
    'welcome.guide.step2.title': 'Slash Commands',
    'welcome.guide.step2.desc': 'Type / at the start of a line to bring up the command menu and quickly insert headings, dividers, images, or paragraphs.',
    'welcome.guide.step3.title': 'Drag-and-Drop Reordering',
    'welcome.guide.step3.desc': 'Hover over any block to reveal the ⠿ handle. Click and drag to reorder blocks.',
    'welcome.guide.step4.title': 'GitHub Cloud Sync',
    'welcome.guide.step4.desc': 'Configure your GitHub Token and repository in settings (⚙️) to save and sync changes directly.',
  ...
  zh: {
    ...
    'welcome.badge': '✨ TeamFlow Wiki v1.2',
    'welcome.subtitle': '为现代开发团队打造的轻量级、卡片模块化协作知识库',
    'welcome.action.start': '开始编写',
    'welcome.action.settings': '配置同步',
    'welcome.action.edit_layout': '编辑此页',
    'welcome.team.title': '项目构建成员',
    'welcome.team.desc': '感谢为 TeamFlow Wiki 项目付出心血的开发与设计小组成员：',
    'welcome.team.role.lead': '项目负责人 / 核心开发',
    'welcome.team.role.frontend': '前端架构师',
    'welcome.team.role.designer': 'UI / 交互设计师',
    'welcome.team.role.ai': 'AI 配对程序员',
    'welcome.guide.title': '使用指南',
    'welcome.guide.desc': '快速掌握 TeamFlow Wiki 的核心协作工作流：',
    'welcome.guide.step1.title': '模块化块级编辑',
    'welcome.guide.step1.desc': '点击任意文本块即可直接编辑，按 Enter 键换行。每一行都是独立积木，可自由修改。',
    'welcome.guide.step2.title': '斜杠命令 (Slash Command)',
    'welcome.guide.step2.desc': '在新行输入 / 即可呼出快捷菜单，一键插入标题、分隔线、图片或普通段落。',
    'welcome.guide.step3.title': '拖拽手柄排序',
    'welcome.guide.step3.desc': '悬停于每一行左侧可显现 ⠿ 手柄，长按即可上下拖拽块重新排布内容顺序。',
    'welcome.guide.step4.title': 'GitHub 自动云同步',
    'welcome.guide.step4.desc': '在设置 (⚙️) 中输入 GitHub Token 及仓库信息后，即可免安装 Git，一键向远端推送更新。',
